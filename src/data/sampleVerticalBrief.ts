...
export const sampleSecurityQuestionnaireAnswerStudio: QuestionnaireItem[] = [
  {
    "id": "kg-suite-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "AI_PLATFORM",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "REUSABLE",
    "questionnaireFamily": "Open JSON specs + canonical hashing + ed25519 signing for the AI procurement era",
    ...
    "currentAnswer": "Eleven open specs published; hash-attestation-rs ships ed25519 signing; audit-stream-py + audit-stream-prometheus feed the same canonical hash chain; 9 of 11 specs have spec landings; all aligned with NIST AI RMF crosswalk.",
    ...
    "answerCoverageScore": 92,
    "evidenceLinkageScore": 90,
    "responseMaturityScore": 89,
    "trustEvidenceScore": 92,
    "turnaroundDays": 2,
  ...
  {
    "id": "ai-procurement-pulse-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "AI_PLATFORM",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "REUSABLE",
    "questionnaireFamily": "Quarterly ed25519-signed crawl of 1,457 domains across 38 verticals scoring AI-procurement disclosure depth",
    "operatingQuestion": "Can we hand a buyer a public, signed measurement of the industry instead of self-report claims?",
    "currentAnswer": "4 published Issues; signing-key indexed at /.well-known/pulse-signing.json; universe.csv at 1,457 domains; scheduled quarterly Action committed for Aug/Nov/Feb/May 15; summarizer auto-drafts Issue body.",
    "headlineGap": "Per-vertical sub-issues would compound buyer signal — currently a single combined report per quarter.",
    "answerCoverageScore": 95,
    "evidenceLinkageScore": 95,
    "responseMaturityScore": 92,
    "trustEvidenceScore": 90,
    "turnaroundDays": 1,
  ...
  {
    "id": "operator-diagnostics-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "REVENUE_SYSTEMS",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "REUSABLE",
    "questionnaireFamily": "Four operator surfaces distinct from /trust/ governance and /calculators/ rubric math",
    "operatingQuestion": "Can a CFO or CRO open one of these surfaces and answer their operator question without a custom build?",
    "currentAnswer": "4 surfaces shipped to v1.0-prod 2026-05-31 (reality, revenue, replace, members); each is a Style01 dark-themed dashboard with synthetic operator data.",
    ...
    "answerCoverageScore": 84,
    "evidenceLinkageScore": 78,
    "responseMaturityScore": 80,
    "trustEvidenceScore": 82,
    "turnaroundDays": 4,
  ...
  {
    "id": "healthtech-clinical-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "HEALTHTECH",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "REUSABLE",
    "questionnaireFamily": "Eight clinical / GxP-territory operator surfaces with explicit 'no compliance claim' discipline",
    ...
    "currentAnswer": "8 surfaces shipped (gxp/assay/capa/narrative/diagnostics/instruments/safety/specimen); language audit returned clean; each carries explicit 'no claim of HIPAA / GMP / GxP / FDA compliance' disclaimer.",
    "headlineGap": "No HealthTech buyer in the pipeline yet — surfaces are show-don't-tell evidence rather than active sales tools.",
    "answerCoverageScore": 87,
    "evidenceLinkageScore": 86,
    "responseMaturityScore": 86,
    "trustEvidenceScore": 84,
    "turnaroundDays": 5,
  ...
  {
    "id": "growth-consent-ops-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "REVENUE_SYSTEMS",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "NEEDS_WORK",
    "questionnaireFamily": "Marketing, consent, and attribution governance — 4 named tracks at growth.kineticgain.com",
    ...
    "currentAnswer": "Growth Ops hub live with 4 tracks; klaviyo-flow-consent-audit + vwo-experiment-governance-mirror + martech-experiment-evidence-stack + identity-lifecycle-workbench + Skyflow-Klaviyo bridge + UTM attribution Go lib all shipped.",
    ...
    "answerCoverageScore": 82,
    "evidenceLinkageScore": 80,
    "responseMaturityScore": 78,
    "trustEvidenceScore": 80,
    "turnaroundDays": 5,
  ...
  {
    "id": "trust-pack-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "AI_PLATFORM",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "REUSABLE",
    "questionnaireFamily": "Eight browser-only AI diligence tools at the apex /trust/ pillar — no backend, no login, no telemetry",
    ...
    "currentAnswer": "8 Trust Pack tools live at kineticgain.com/trust/ (AI System Card, Evidence Locker, Shadow AI Discovery, AI Vendor Intake, AI Tabletop, Risk Register, Subprocessors, Vendor AI Disclosure Review); all vanilla JS + inline CSS + under 30KB.",
    "headlineGap": "Per-tool usage analytics not present — choosing which to deepen next is currently guesswork.",
    "answerCoverageScore": 91,
    "evidenceLinkageScore": 89,
    "responseMaturityScore": 89,
    "trustEvidenceScore": 93,
    "turnaroundDays": 2,
  ...
  {
    "id": "sales-enablement-stack-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "REVENUE_SYSTEMS",
    "reviewStage": "INTAKE",
    "answerState": "NEEDS_WORK",
    "questionnaireFamily": "Four seller-side operator surfaces — proof-gap monitor, trust-center evidence room, security-questionnaire answer studio, RFP response assembler",
    ...
    "currentAnswer": "4 surfaces shipped + hardened to v1.0-prod 2026-05-31; SSL provisioning on subdomain HTTPS (HTTP confirms live); THIS fixture is the dogfood (you are looking at it).",
    "headlineGap": "Subdomain SSL first-time-provisioning lag (auto-resolves in 24h); per-surface analytics not yet wired.",
    "answerCoverageScore": 78,
    "evidenceLinkageScore": 80,
    "responseMaturityScore": 75,
    "trustEvidenceScore": 82,
    "turnaroundDays": 1,
  ...
  {
    "id": "kinetic-gain-embedded-answer-pack",
    "owner": "Miz Causevic (solo founder)",
    "buyer": "Enterprise security questionnaire reviewer · SIG/CAIQ assessor",
    "sector": "AI_PLATFORM",
    "reviewStage": "SECURITY_REVIEW",
    "answerState": "NEEDS_WORK",
    "questionnaireFamily": "Drop-in audit-stream + Decision Card vault contract SDK for B2B SaaS embedders",
    ...
    "currentAnswer": "Phase 1 SDK shipped at v0.1.1; TypeScript dual ESM/CJS; zero runtime deps; Procurement Packet Starter shipped in docs/sales/; npm-publish workflow wired but blocked on NPM_TOKEN.",
    ...
    "answerCoverageScore": 76,
    "evidenceLinkageScore": 78,
    "responseMaturityScore": 70,
    "trustEvidenceScore": 72,
    "turnaroundDays": 7,
